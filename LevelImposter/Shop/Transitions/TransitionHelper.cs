...
public static class TransitionHelper
{
    ...
    private static T LerpTransition<T>(TransitionParams<T> transitionParams, float t)
    {
        ...
        {
            TransitionParams<float> floatParams => (T)(object)Mathf.Lerp(floatParams.FromValue, floatParams.ToValue,
                easedT),
            TransitionParams<Vector3> vector3Params => (T)(object)Vector3.Lerp(vector3Params.FromValue,
                vector3Params.ToValue, easedT),
