...
namespace LevelImposter.Core
{
    ...
    public static class BinocularsPatch
    {
        public static void Prefix(FungleSurveillanceMinigame __instance)
        {
            ...
            PlainShipRoom tempRoom = __instance.gameObject.AddComponent<PlainShipRoom>();
        ...
        public static void Postfix(FungleSurveillanceMinigame __instance)
        {
            ...
            if (lastPos != Vector2.zero)
                ...
                __instance.securityCamera.transform.position = BinocularsBuilder.CameraOffset + __instance.transform.position;
