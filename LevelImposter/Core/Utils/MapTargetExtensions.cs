...
public static class MapTargetExtensions
{
    ...
    {
        return mapTarget == MapTarget.Game ? GCBehavior.DisposeOnMapUnload : GCBehavior.DisposeOnLobbyUnload;
    }
    ...
    {
        return mapTarget == MapTarget.Game ? GameConfiguration.CurrentMap : GameConfiguration.CurrentLobbyMap;
    }
}